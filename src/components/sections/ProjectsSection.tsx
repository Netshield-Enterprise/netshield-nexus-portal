...
const ProjectsSection = () => {
  ...
  const upcomingServices = [
    ...
    },
    {
      ...
      description: "Custom security solutions tailored to client environment",
    ...
    <section id="projects" className="py-20 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="font-inter font-bold text-2xl text-foreground">
                        {project.client}
                      </h3>
                      <p className="text-muted-foreground font-inter">{project.type}</p>
                    </div>
                  </div>
                  
                  <div className="mb-6">
                    <h4 className="font-inter font-semibold text-lg mb-2 text-primary">
                      {project.service}
                    </h4>
                ...
                <div className="lg:col-span-1">
                  <div className="bg-card p-6 rounded-lg border border-border/50">
                    ...
                    <div className="mt-6 pt-4 border-t border-border/50">
                      <span className="text-xs text-muted-foreground font-inter">Status: </span>
                      <span className="text-sm font-semibold text-primary font-inter">{project.status}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <h3 className="font-inter font-bold text-2xl text-center mb-8 text-foreground">
            ...
            {upcomingServices.map((service, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h4 className="font-inter font-semibold text-foreground">{service.title}</h4>
                    <p className="text-xs text-secondary font-inter">{service.status}</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground font-inter">{service.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-card p-8 rounded-xl border border-border/50 max-w-2xl mx-auto">
            <h3 className="font-inter font-bold text-xl mb-4 text-foreground">
            ...
            <button 
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 rounded-lg font-semibold transition-colors duration-200 font-inter"
            >
