        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-card/50 backdrop-blur-sm p-8 rounded-xl border border-border/50 hover:border-primary/50 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="font-orbitron font-bold text-2xl text-primary">Mission</h3>
            </div>
          ...
          <div className="bg-card/50 backdrop-blur-sm p-8 rounded-xl border border-border/50 hover:border-secondary/50 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="font-orbitron font-bold text-2xl text-secondary">Vision</h3>
            </div>
            <p className="text-muted-foreground leading-relaxed text-lg">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Staying ahead of threats with cutting-edge solutions</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Delivering accurate and actionable security insights</p>
            </div>
            <div className="text-center">
              <div className="bg-secondary/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Eye className="w-8 h-8 text-secondary" />
              </div>
              <h4 className="font-semibold text-lg mb-2">Vigilance</h4>
              <p className="text-muted-foreground">Constant monitoring and proactive threat detection</p>
            </div>
          </div>
        </div>
      </div>
